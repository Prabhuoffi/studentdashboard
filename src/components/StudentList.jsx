    ...
    <div className="table-container mt-8 px-3 h-[450px] overflow-y-auto mb-6">
      <table className="relative">
        <thead className="sticky top-0 bg-white shadow-sm z-10">
          <tr className="text-gray-500 sticky text-start border-b">
            <th
                    ...
                    {selectedStudent === student._id && (
                      ...
                      >
                        <button
                          ...
                          className=" px-4 py-2 text-sm hover:bg-gray-100 w-full text-left flex items-center gap-1 text-blue-500"
                        >
                          <MdEdit /> Edit
                        </button>
                        <button
                          onClick={() => handleDelete(student._id)}
                          className=" px-4 py-2 text-sm hover:bg-gray-100 w-full text-left flex items-center gap-1 text-red-500"
                        >
