  ...
  return (
    <div className="w-fit  border bg-[#fff] rounded-md px-3 shadow-lg">
      <div className="w-full border-b border-gray-200 py-4 px-3 flex items-center gap-2">
        <h1 className="font-bold text-[1.1rem]">Student Dashboard</h1>
      </div>
      <div className="flex items-center mt-8 px-3 justify-between">
        <div className=" flex items-center justify-center gap-6 text-black">
          ...
          />
          <button
            className=" flex items-center gap-2 ml-3 border bg-green-500 p-2 px-3 rounded-md"
            onClick={exportToCSV}
          >
            <PiExport size={20} />
            Export
        ...
        <button
          className="bg-[#333fff] text-white p-2 px-3 rounded-md flex items-center justify-center gap-1"
